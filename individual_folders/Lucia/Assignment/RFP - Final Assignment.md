...
* I have used the [OECD](https://data-explorer.oecd.org/) website to retrieve data on population demography (year 2022) of vulnerable people living in specific locations by filtering the Historical population data with the countries of my interest.
